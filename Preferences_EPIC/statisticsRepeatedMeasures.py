...
dependent_variables = data.columns[3:]  # first 3 columns are SubjectID, AssistanceMagnitude, and TimingDelay

output_folder = os.path.dirname(file_path)  # output folder lol

# Loop over each dependent variable and perform RM-ANOVA
